const page2 = {
  text: `<div class="container page2hidden">
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   width="98px" height="100px" viewBox="0 0 98 100" enable-background="new 0 0 98 100" xml:space="preserve" class="beer faded">
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   width="98px" height="100px" viewBox="0 0 98 100" enable-background="new 0 0 98 100" xml:space="preserve" class="beer-reverse faded">
<path fill="#FFFFFF" d="M85.715,26.547h-7.457c1.711-5.512,0.539-11.744-3.043-15.975c-3.587-4.236-9.158-6.766-14.896-6.766
  c-4.109,0-7.852,1.29-10.733,3.6c-3.045-4.6-9.469-7.03-15.613-7.03c-7.055,0-14.166,3.225-16.001,10.323
  c-1.147-0.196-2.492-0.347-3.91-0.347c-8.456,0-13.503,5.16-13.846,14.155c-0.185,4.844,1.047,8.677,3.662,11.394
  c1.359,1.413,3.049,2.442,4.988,3.094v48.546c0,6.663,5.421,12.083,12.083,12.083h43.364c6.662,0,12.084-5.42,12.084-12.083v-9.373
...
<p class="page2text">Хочеться побажати хорошого настрою, а також вдало провести час в кругу близьких людей</p>
</div>`,
  init: function (body) {
    body.className = "page2body";
    body.innerHTML = this.text;
    setTimeout(() => {
      body.appendChild(scroll);
    }, 2000);
    setTimeout(() => {
      document.querySelector(".page2hidden").classList.remove("page2hidden");
      document
        .querySelectorAll(".faded")
        .forEach((x) => x.classList.remove("faded"));
    }, 1000);
  },
};
