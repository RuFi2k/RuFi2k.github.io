const page3 = {
  text: `<div class="page3container page3hidden">
...
V117.8z" />
  ...
  <g class="speedLines" stroke="#3e3e3e" stroke-width="2" stroke-linejoin="round">
    <line id="speedLine0" fill="none" stroke="none" stroke-miterlimit="10" x1="252.5" y1="324" x2="252.5" y2="566" />
    <line id="speedLine1" fill="none" stroke="none" stroke-miterlimit="10" x1="299.5" y1="500" x2="299.5" y2="557" />
    <line id="speedLine2" fill="none" stroke="none" stroke-miterlimit="10" x1="347.5" y1="324" x2="347.5" y2="529" />
    <line id="speedLine3" fill="none" stroke="none" stroke-miterlimit="10" x1="74.5" y1="45" x2="74.5" y2="500" />
    <line id="speedLine4" fill="none" stroke="none" stroke-miterlimit="10" x1="544.5" y1="29" x2="544.5" y2="574" />
    <line id="speedLine5" fill="none" stroke="none" stroke-miterlimit="10" x1="415.5" y1="8" x2="415.5" y2="440" />
    <line id="speedLine6" fill="none" stroke="none" stroke-miterlimit="10" x1="165.5" y1="142" x2="165.5" y2="574" />
  </g>
...
<p class="page3text">Летiти до мрiй, якими б амбiцiйними вони не були</p>
  ...
  init: function (body) {
    ...
    setTimeout(() => {
      document.querySelector(".page3hidden").classList.remove("page3hidden");
    }, 1000);
    page3Animation();
  },
};
